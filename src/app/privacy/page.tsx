            ...
            <div className="mb-8 prose prose-lg break-words max-w-none dark:prose-invert prose-a:text-blue-700 prose-a:no-underline hover:prose-a:text-blue-500 dark:prose-a:text-blue-300 dark:hover:prose-a:text-blue-500">
                <div className="flex w-full px-4 pt-12 text-center">
                    <div className="w-full">
                        ...
                        <h2 className="px-6 pt-6 pb-12 text-xl leading-relaxed dark:text-gray-300 sm:px-24">
                            We treat your privacy with upmost respect. Exact details are outlined below as
                            plainly as possible. If you have any questions,{' '}
                ...
                <article className="my-6 md:my-10">
                    ...
                    <ul>
                        ...
                        <li>
                            <b>Feedback and correspondence,</b> such as information you provide when you
                            report a problem with the Sites or otherwise correspond with us.
                        </li>
                        <li>
                    ...
                    <p>
                        ...
                        third party site could provide to us based on your settings on that third party site.
                        We will access, use and store that information in accordance with this Privacy Policy.
                        You can revoke our access to the information you provide in this way at any time by
                        amending the appropriate settings from within your account settings on the applicable
                        third party site.
                    </p>
                    <p>
                    ...
                    <p>
                        To make our Sites more useful to you, our servers (which may be hosted by a third
                        party service provider) collect information from you, including your browser type,
                        operating system, Internet Protocol (“IP”) address (a number that is automatically
                        assigned to your computer when you use the Internet, which may vary from session to
                    ...
                    <p>
                        ...
                        to register you and/or your company for an account and to communicate with you
                        regarding Axiom and our Sites, including by sending you announcements, updates, and
                    ...
                    <ul>
                        ...
                        <li>
                            better understand your needs and interests, and personalize your experience with
                            the Sites; and
                        </li>
                    ...
                    <p>
                        ...
                        other information to analyze trends, administer the Sites, analyze users&apos;
                        movements around the Sites, gather demographic information about our user base as a
                        whole and improve the Sites.
                    </p>
                    <p>
                    ...
                    <p>
                        <b>To create anonymous data.</b> We may create aggregated and other anonymous data
                        from our users&apos; information. We make personal information into anonymous data by
                    ...
                    <p>
                        <b>For compliance, fraud prevention and safety.</b> We may use your personal
                        information as we believe appropriate to (a) investigate violations of and enforce our
                        Terms of Use; (b) protect our, your or others&apos; rights, privacy, safety or
                        property (including by making and defending legal claims); and (c) protect,
                    ...
                    <p>
                        ...
                        appropriate to (a) comply with applicable laws, lawful requests and legal process,
                        such as to respond to subpoenas or requests from government authorities; and (b) where
                    ...
                    <p>
                        ...
                        as we believe appropriate to government or law enforcement officials or private
                        parties for the purposes described above under the following sections: For compliance,
                        fraud prevention and safety and For compliance with law.
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        Technologies), you have several choices regarding use of information with respect to
                        our Sites:
                    </p>
                    <p>
                        ...
                        unsubscribe instructions provided in the e-mail you receive or by contacting us
                        directly at contact@axiom.co. You may continue to receive service-related and other
                        non-marketing emails.
                    </p>
                    <p>
                        <b>Changes to your personal information.</b> If your personal information changes
                        during your relationship with us, you may update your personal information by emailing
                        us at privacy@axiom.co. You may also request deletion of your personal information by
                        us, and we will use commercially reasonable efforts to honor your request, but please
                        note that we may be required to keep such information and not delete it (or to keep
                        this information for a certain time, in which case we will comply with your deletion
                        request only after we have fulfilled such requirements). When we delete any
                        information, it will be deleted from the active database, but may remain in our
                        archives. We may also retain your information for fraud or similar purposes.
                    </p>
                    <p>
                        <b>Choosing not to share your personal information.</b> Where we are required by law
                        to collect your personal information, or where we need your personal information in
                        order to provide the Sites to you, if you do not provide this information when
                        requested (or you later ask to delete it), we may not be able to provide you with the
                        Sites. We will tell you what information you must provide to receive the Sites by
                        designating it as required or through other appropriate means.
                    </p>
                    <p>
                        We may allow service providers and other third parties to use cookies and other
                        tracking technologies to track your browsing activity over time and across the Sites
                        and third party websites. For more details, see our Cookie Policy. Some Internet
                        browsers may be configured to send “Do Not Track” signals to the online services that
                        you visit. We currently do not respond to “Do Not Track” or similar signals. To find
                    ...
                    <p>
                        ...
                        and information technologies and we cannot guarantee the absolute security of your
                        personal information. We will comply with applicable laws and regulations requiring
                        that we notify you in the event your personal information is compromised as a result
                        of a breach of our security measures.
                    </p>
                    <p>
                        <b>Third party sites and services.</b> Our Sites may contain links to third party
                        websites. When you click on a link to any other website or location, you will leave
                        our Sites and go to another site and another entity may collect personal and/or other
                        information from you. We have no control over, do not review, and cannot be
                        responsible for, these outside websites or their content. Please be aware that the
                        terms of this Privacy Policy do not apply to these outside websites or content, or to
                        any collection of your personal information after you click on links to such outside
                        websites. We encourage you to read the privacy policies of every website you visit.
                        The links to third party websites or locations are for your convenience and do not
                    ...
                    <p>
                        ...
                        effective date of the change. If we make material changes to this Privacy Policy we
                        will notify you by email or through the Sites.
                    </p>
                    ...
                    <p>
                        Controller. Axiom is the controller of your personal information covered by this
                        Privacy Policy for purposes of European data protection legislation.
                    </p>
                    <p>
                    ...
                    <ul>
                        ...
                        <li>
                            You have entered a contract with us and we need to use your personal information
                            to provide services you have requested or take steps that you request prior to
                            providing services.
                        </li>
                    </ul>
                    ...
                    <p>
                        Processing is based on your consent. Where we rely on your consent you have the right
                        to withdraw it anytime in the manner indicated in the Sites.
                    </p>
                    <h3>To share your personal information as described in this Privacy Policy</h3>
                    <p>
                        This sharing constitutes our legitimate interests, and in some cases may be necessary
                        to comply with our legal obligations.
                    </p>
                    <h2>Retention</h2>
                    <p>
                        Generally, we retain your personal information for as long as necessary to process
                        your personal information as described in this Privacy Policy unless a longer
                    ...
                    <ul>
                        ...
                        <li>
                            <b>Transfer.</b> Transfer a machine-readable copy of your personal information to
                        ...
                        <li>
                            <b>Object.</b> Object to our reliance on our legitimate interests as the basis of
                    ...
                    <p>
                        ...
                        contact us or submit a complaint to the data protection regulator in your
